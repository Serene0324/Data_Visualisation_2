...
vegaEmbed("#stacked_bar_chart", vg_2, { actions: false }).then(function(result) {
    
}).catch(console.error);

var vg_3 = "bubble_plot.vg.json";
vegaEmbed("#bubble_plot", vg_3, { actions: false }).then(function(result) {
    
}).catch(console.error);

var vg_4 = "gender_divergingbar.vg.json";
vegaEmbed("#diverging_bar_chart", vg_4, { actions: false }).then(function(result) {
